            ...
            >
              ...
              <div className="p-5">
                ...
                <div className="flex items-center justify-between pt-4" style={{ borderTop: '1px solid rgba(0,170,255,0.1)' }}>
                  <div style={{ color: '#ffc93c', fontSize: '1.25rem', fontWeight: 900, lineHeight: 1.2 }}>
                    {formatPrice(product.price)}{' '}
                    <span style={{ color: '#8ca0bb', fontSize: '0.75rem', fontWeight: 600 }}>FCFA</span>
                  </div>
                  <a
                    href={`https://wa.me/237650922053?text=Hi T-Saint Tec! I'm interested in the ${product.name}. Is it still available?`}
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center gap-1.5 font-bold no-underline transition-opacity duration-200 hover:opacity-80"
                    style={{ color: '#25d366', fontSize: '0.875rem' }}
                  >
